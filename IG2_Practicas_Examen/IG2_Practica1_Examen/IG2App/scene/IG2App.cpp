...
void IG2App::escenaDron() {
	...
	vEntities[vEntities.size() - 1]->getNode()->setScale(0.2, 0.2, 0.2);
	vEntities[vEntities.size() - 1]->getNode()->translate(0, 540, 0);
